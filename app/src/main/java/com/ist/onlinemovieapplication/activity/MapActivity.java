...
import com.ist.onlinemovieapplication.utile.AppUtiles;
import com.ist.onlinemovieapplication.utile.AutoCompleteAdapter;
import com.ist.onlinemovieapplication.utile.GpsLocationTracker;
...
public class MapActivity extends AppCompatActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    private static final String TAG = "MP aCTIVITY";
    ...
    private void createLocationCallback() {
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                Toast.makeText(MapActivity.this, String.valueOf(mCurrentLocation.getSpeed()), Toast.LENGTH_SHORT).show();
